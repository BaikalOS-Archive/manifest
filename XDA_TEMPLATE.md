...
Please replace {VAR} with your values before past.
...
[B]Supported devices:[/B] {YOU_SUPPORTED_DEVICE_NAMES}
[LIST][*] [B]BaikalOS official builds[/B] with delta-ota: [URL="https://dl.baikalos.ru/"]DOWNLOAD[/URL]
...
[B]ChangeLog:[/B] [url]https://dl.baikalos.ru/{YOU_DEVICE}/Changelog.txt[/url]
...
[B]Minimum required versions:[/B] {YOU_FIRMWARE_VERSION}
[B]Download:[/B] [URL="{FIRMWARE_URL}"]here[/URL]
...
[SIZE="3"][B]ROM maintained by:[/B][/SIZE]
[LIST][*] {YOU_XDA_NAME}[/LIST]
...
[*] For maintain, bringup, trees for {device} [B][URL="{YOU_DONATE_URL}"][U][COLOR="Blue"][B]Pay[/B][/COLOR][/B][COLOR="DeepSkyBlue"][B]Pal[/B][/COLOR][/U][/URL][/LIST]
